...
<<<<<<< HEAD
    ...
    console.log(`   • Categorías existentes: ${existingData.categories.length}`);
...
<<<<<<< HEAD
    ...
    await db.batch(propertyData.categoryRelations.map(r => db.insert(PropertyCategories).values(r)));
