...
### Sombras
```html
<div class="bg-white shadow-primary p-6">
  Sombra azul
</div>

<div class="bg-white shadow-accent p-6">
  Sombra roja
</div>
```
...
### Botón Principal
```html
<button class="bg-[--color-primary] hover:bg-[--color-primary-dark] text-white px-6 py-3 rounded-lg transition-colors">
  Buscar Propiedades
</button>
```
...
### Botón de Acción
```html
<button class="bg-[--color-accent] hover:bg-[--color-accent-dark] text-white px-6 py-3 rounded-lg transition-colors">
  Contactar Ahora
</button>
```
...
### Tarjeta
```html
<div class="bg-white border-2 border-[--color-primary] rounded-xl p-6 shadow-primary">
