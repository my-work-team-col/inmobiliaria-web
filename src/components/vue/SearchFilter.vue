...
const categories = ["Apartamento", "Casa", "Finca", "Habitación"];
...
<template>
  <div
    class="w-full bg-white/70 backdrop-blur-sm rounded-[2.5rem] border border-gray-100 shadow-xl flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-4 md:gap-6 p-4 md:p-6 lg:p-8 items-stretch sm:items-end"
  >
    <!-- CATEGORY -->
    <div class="flex-1 min-w-[220px] max-w-full relative">
      <label
        class="block text-xs md:text-sm font-medium text-gray-600 pl-1 pb-1"
      >
        Categoría
      </label>
      ...
      <button
        ...
        class="w-full text-left rounded-full border border-gray-200 bg-gray-50 px-4 md:px-5 py-3 text-gray-700 hover:bg-gray-100 transition flex justify-between items-center shadow-sm"
    ...
    <div class="flex-1 min-w-[220px] max-w-full flex items-end">
      <button
        class="w-full bg-pink-600 hover:bg-pink-700 text-white font-semibold py-3 md:py-3.5 px-6 rounded-full shadow-lg transition flex items-center justify-center gap-2 text-base md:text-lg"
      >
        <svg
